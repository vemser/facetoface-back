...
INSERT INTO VEM_SER.GENERO (ID_GENERO,NOME)
VALUES (SEQ_GENERO.nextval,'Masculino');

INSERT INTO VEM_SER.GENERO (ID_GENERO,NOME)
VALUES (SEQ_GENERO.nextval,'Feminino');

INSERT INTO VEM_SER.GENERO (ID_GENERO,NOME)
VALUES (SEQ_GENERO.nextval,'Outros');

-- TRILHA ----

INSERT INTO VEM_SER.TRILHA (ID_TRILHA,NOME)
...
INSERT INTO VEM_SER.LEGENDA (ID_LEGENDA,NOME)
VALUES (SEQ_LEGENDA.nextval,'Confirmada');

INSERT INTO VEM_SER.LEGENDA (ID_LEGENDA,NOME)
VALUES (SEQ_LEGENDA.nextval,'Pendente');

INSERT INTO VEM_SER.LEGENDA (ID_LEGENDA,NOME)
VALUES (SEQ_LEGENDA.nextval,'Cancelada');

INSERT INTO VEM_SER.LEGENDA (ID_LEGENDA,NOME)
VALUES (SEQ_LEGENDA.nextval,'Outros');

--- USUARIO ADMINISTRADOR ----

INSERT INTO VEM_SER.USUARIO(ID_USUARIO, SENHA, ID_TRILHA, ID_GENERO, NOME_COMPLETO, CIDADE, ESTADO, EMAIL, ATIVO)
VALUES (SEQ_ID_USUARIO.nextval,'123', 4, 3, 'ADMIN', 'PORTO ALEGRE', 'RIO GRANDE DO SUL', 'julio.gabriel@dbccompany.com', 'T');

-- tabela n - n ----

INSERT INTO VEM_SER.USUARIO_PERFIL(ID_USUARIO, ID_PERFIL)
VALUES(1,3);