...
CREATE TABLE FOTOS (
  ...
  CONSTRAINT FK_FOTOS_ID_USUARIO FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO (ID_USUARIO),
  CONSTRAINT FK_FOTOS_ID_CANDIDATO FOREIGN KEY (ID_CANDIDATO) REFERENCES CANDIDATO (ID_CANDIDATO)
);
...
CONSTRAINT FK_CURRICULO_ID_CANDIDATO FOREIGN KEY (ID_CANDIDATO) REFERENCES CANDIDATO (ID_CANDIDATO)
);
