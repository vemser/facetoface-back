...
//    public ResponseEntity<EntrevistaDTO> cadastrarEntrevista(@Valid @RequestBody EntrevistaCreateDTO entrevistaCreateDTO,
//                                                             Legenda legenda) throws RegraDeNegocioException{
//        return new ResponseEntity<>(entrevistaService.createEntrevista(entrevistaCreateDTO, legenda), HttpStatus.OK);
//    }
//
